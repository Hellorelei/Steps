...
export interface KAPLAYCtx<TButtonDef extends ButtonsDef = {}, TButton extends string = string> {
     ...
     * @group Input
     */
    onGamepadButtonDown(btn: KGamepadButton | KGamepadButton[], action: (btn: KGamepadButton) => void): KEventController;
    /**
     ...
     * @group Input
     */
    onGamepadButtonDown(action: (btn: KGamepadButton) => void): KEventController;
    /**
